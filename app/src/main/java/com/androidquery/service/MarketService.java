...
{
	/** Update sync level REVISION. */
	public static final int REVISION = 0;
	/** Update sync level MINOR. */
	public static final int MINOR = 1;
	/** Update sync level MAJOR. */
	...
	/**
	 * Set the update sync granularity level. Default is REVISION.
	 * <p/>
	 * <br>
	 * <p/>
	...
	/**
	 * Display a progress view during version sync.
	 *
	 * @param id view id
	 * @return self
	 */
	...
	/**
	 * Force a version sync against the AQuery server and show a dialog regardless of versions.
	 *
	 * @param force force an update sync
	 * @return self
	 */
	...
	/**
	 * The time duration which last version sync expires. Default is 10 hours.
	 *
